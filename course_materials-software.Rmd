...
However, **Please update your installation when the class begins** - R goes through regular updates and works best with the newest version.
...
As a back-up to running R on your desktop I'll also introduce you to [RStudio Cloud](https://rstudio.cloud/.  There are also several excellent [primers](https://rstudio.cloud/learn/primers) which we'll use.  
